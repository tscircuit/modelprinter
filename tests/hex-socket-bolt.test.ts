...
describe("metric hex socket bolts", () => {
  test("parses the M3 x 6mm model and preserves raw parameters", () => {
  ...
  test("supports fractional metric sizes, units, and smooth shanks", () => {
    expect(
  ...
  test("schema rejects unknown props and nonfinite lengths", () => {
  ...
  test.each(
    ...
    "%s mesh is finite, closed, consistently wound, and correctly sized",
    (metricSize) => {
  ...
  test("threading changes the shank and leaves the head geometry intact", () => {
